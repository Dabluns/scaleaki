...
const planos: Plano[] = [
  {
    ...
    descricao: 'ACESSO_INICIAL_AO_SISTEMA',
    icon: Calendar,
    color: 'blue',
    beneficios: [
      'ACESSO_BÁSICO_ATIVO',
  ...
  },
  {
    ...
    desconto: 33,
    descricao: 'DESEMPENHO_OTIMIZADO',
    popular: true,
    icon: Zap,
    color: 'cyan',
    beneficios: [
      'TODOS_OS_RECURSOS_BÁSICOS',
      '33%_DE_DESCONTO_APLICADO',
      'ROTEAMENTO_PRIORITÁRIO',
      'RELATÓRIOS_DETALHADOS',
      'ACESSO_LIVRE_A_API',
    ],
  },
  {
    ...
    desconto: 34,
    descricao: 'REDE_DE_EFICIÊNCIA_MÁXIMA',
    icon: Crown,
    color: 'green',
    beneficios: [
      'TODOS_OS_SISTEMAS_PRO',
      '34%_DE_DESCONTO_MAXIMO',
      'SUPORTE_CRÍTICO_24/7',
      'MÉTRICAS_AVANÇADAS',
      'MÓDULOS_EM_FATOR_BETA',
      'CONSULTORIA_ESTRATÉGICA',
    ],
  },
];
    ...
    <div className="min-h-screen bg-black text-white pb-32 overflow-x-hidden">
      ...
      <div className="relative pt-16 pb-12 px-6 lg:px-12 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col xl:flex-row xl:items-end justify-between gap-16 border-b border-white/5 pb-16">
          <div className="space-y-10 flex-1">
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-4 px-6 py-2.5 rounded-full bg-white/5 border border-white/5 text-white/40 font-black text-[10px] uppercase tracking-[0.4em] italic">
                ...
                AQUISIÇÃO_DE_LICENÇA // SINCRONIA_DE_SISTEMA
              </div>
              <div className="flex items-center gap-3 border-l border-white/5 pl-6">
                <ShieldCheck size={14} className="text-white/20" />
                <span className="text-[10px] font-black text-white/20 uppercase tracking-widest font-mono">CRIPTOGRAFIA: AES-256</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black italic uppercase tracking-tighter leading-[0.8] drop-shadow-2xl">
                PLANOS DO<br />
                <span className="text-green-500">SISTEMA</span>
              </h1>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-10 pt-6">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-green-500/40 uppercase tracking-widest font-mono">FATOR_DE_ESCALA</span>
                  <span className="text-[14px] font-black text-white uppercase tracking-tighter italic font-mono">NÓS_ILIMITADOS</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-8 xl:min-w-[400px]">
            {[
              { label: 'Confiabilidade', value: '99.9%', icon: Activity },
              { label: 'Nível_do_Sistema', value: 'TIER_5', icon: Cpu }
            ].map((item, i) => (
      ...
      <div className="max-w-6xl mx-auto mt-20 text-center space-y-8">
        <div className="flex items-center justify-center gap-8 opacity-20">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.4em] italic">GATEWAY_DE_PAGAMENTO_SEGURO</span>
          <div className="w-px h-4 bg-white" />
          <CreditCard size={20} />
        </div>
