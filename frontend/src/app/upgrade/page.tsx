...
const PLUS_CHECKOUT =
  process.env.NEXT_PUBLIC_CHECKOUT_PLUS_URL || '/checkout?plano=plus';
        ...
        >
          {isPlus ? (
            ...
            <>
              <Link
                href={PLUS_CHECKOUT}
                className="group flex items-center gap-3 rounded-2xl bg-purple-500 px-10 py-5 text-lg font-black uppercase tracking-wide text-white transition hover:bg-purple-400 hover:shadow-[0_0_40px_rgba(168,85,247,0.4)]"
              >
