            ...
            <Link href="/criar-oferta" className="block">
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="text-lg lg:text-xl font-black text-white tracking-tighter">
                    NOVA OFERTA
                  </h3>
                </div>
        ...
        <motion.div variants={itemAnim}>
          <Link href="/ofertas?sort=popular" className="block">
            <Card3D
              ...
              has3DRotation={true}
              glow={true}
              className="group relative h-full flex flex-col justify-between p-6 bg-emerald-500/5 hover:bg-emerald-500/10 transition-colors border-white/5 overflow-hidden"
            >
              <div className="flex justify-between items-start mb-6">
                <div className="w-12 h-12 rounded-2xl bg-emerald-500 flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)] group-hover:scale-110 transition-transform flex-shrink-0">
          ...
          <Link href="/favoritos" className="block">
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <Plus className="w-4 h-4 text-green-500/40" />
              </div>
              <div className="min-w-0">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40 mb-2 block truncate">
                  Curadoria
