  ...
  return (
    ...
    >
      ...
      <div className="relative group flex-1 min-w-[220px] max-w-xs">
        ...
        <Search size={13} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/65 group-focus-within:text-green-400 transition-colors" />
        <input
          type="text"
          placeholder="FILTRAR ANÚNCIOS..."
          defaultValue={filters.search}
          onChange={(e) => set({ search: e.target.value || undefined })}
          className="relative w-full pl-10 pr-4 py-3 bg-white/[0.03] border border-white/5 rounded-2xl text-[13px] font-black text-white tracking-widest uppercase focus:outline-none focus:border-green-500/30 placeholder:text-white/75"
        />
      </div>
      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-white/[0.03] border border-white/5 rounded-2xl hover:border-white/10 transition-colors">
        ...
        <span className="text-[11px] font-black text-white/70 uppercase tracking-widest">Escala ≥</span>
        <input
          type="number"
          min={0}
          max={100}
      ...
      {/* ── Contador ──────────────────────────────────────────────────── */}
      <div className="ml-auto text-[11px] font-black text-white/70 uppercase tracking-widest tabular-nums">
